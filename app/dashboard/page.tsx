              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-150 shadow-sm flex flex-col justify-between min-h-[110px]">
                  ...
                  <div className="flex items-baseline justify-between mt-2">
                    ...
                    <span className="text-xs font-bold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-100/50">+2 this month</span>
                  </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-150 shadow-sm flex flex-col justify-between min-h-[110px]">
                  ...
                  <div className="flex items-baseline justify-between mt-2">
                    ...
                    <span className="text-xs font-bold text-amber-600 bg-amber-50 px-2.5 py-1 rounded-lg border border-amber-100/50">Active focus</span>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <button onClick={() => router.push("/complaints")} className="border border-gray-200 hover:bg-slate-50 text-gray-650 font-bold px-4 py-2 rounded-xl text-xs flex items-center gap-1.5 shadow-sm active:scale-[0.98] select-none cursor-pointer">
                      Filter
                    </button>
                    <button onClick={() => router.push("/complaints")} className="border border-gray-200 hover:bg-slate-50 text-gray-650 font-bold px-4 py-2 rounded-xl text-xs flex items-center gap-1.5 shadow-sm active:scale-[0.98] select-none cursor-pointer">
                      Sort
