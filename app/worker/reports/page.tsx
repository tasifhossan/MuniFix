...
export default function WorkerReportsPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex font-sans">
      <WorkerSidebar activeNav="reports" />
        ...
        <main className="px-6 sm:px-8 py-6 space-y-8 flex-1">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
              ...
              <p className="text-slate-700 font-bold text-sm">Failed to load reports</p>
            ...
            <section className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs font-semibold mt-0.5">
                    {resolvedTasks.length > 0
                      ? `You have successfully resolved ${resolvedTasks.length} task${resolvedTasks.length !== 1 ? "s" : ""}.`
                      : "No completed reports recorded."}
                  </p>
                </div>
              ...
              {resolvedTasks.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 bg-slate-50 rounded-3xl border border-dashed border-slate-200 text-center gap-3">
                  ...
                  <p className="text-slate-700 font-bold text-sm">No resolved tasks</p>
                  <p className="text-slate-400 text-xs">You haven't resolved any tasks yet.</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
